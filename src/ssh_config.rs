...
";
    ...
    #[test]
    fn supports_equals_quotes_windows_paths_and_keeps_first_identity_file() {
        let cfg = r#"
Host quoted
...
"#;
        let hosts = parse_str(cfg, Path::new("/home/me"));
        assert_eq!(hosts.len(), 1);
        assert_eq!(hosts[0].hostname, "quoted.example.com");
        assert_eq!(hosts[0].user, "deploy");
        assert_eq!(hosts[0].identity_file, "C:/Users/me/.ssh/id_rsa");
    }

    #[test]
    fn skips_wildcard_negated_and_question_mark_hosts() {
        let cfg = "\
Host *
  HostName any
Host !bad
